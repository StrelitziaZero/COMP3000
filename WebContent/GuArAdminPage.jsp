<!--Administrator information modification interface  -->
...
//String sex=request.getParameter("upsex");
...
if(username!=null&&password!=null&&names!=null&&sex!=null&&address!=null&&phone!=null&&username!=""&&password!=""&&names!=""&&sex!=""&&address!=""&&phone!=""){
	...
	if(guAr11=="b"){
		...
		GuAr guAr3 = new GuArDB().addGuAr(username,password,names,sex,address,phone,abc);
	...
	if(delete!=null&&delete!=""){
		GuAr guAr1 = new GuArDB().deleteGuArAd(delete);
	    delete=null;
	    %>
		<script>
	...
	//update, Determine if the database has the same user name
	if(upid!=null&&upusername!=null&&upid!=""&&upusername!=""){
		...
		if(guAr111=="b"){
			...
			GuAr guAr22 = new GuArDB().updateausernameA(upid,upusername);
		    upusername=null;
		    %>
			<script>
	...
	if(upid!=null&&uppassword!=null&&upid!=""&&uppassword!=""){
		GuAr guAr3 = new GuArDB().updatepasswordA(upid,uppassword);
	    uppassword=null;
	    %>
		<script>
	...
	if(upid!=null&&upname!=null&&upid!=""&&upname!=""){
		GuAr guAr4 = new GuArDB().updatenameA(upid,upname);
	    upname=null;
	    %>
		<script>
	...
	if(upid!=null&&upsex!=null&&upid!=""&&upsex!=""){
		GuAr guAr5 = new GuArDB().updatesexA(upid,upsex);
	    upsex=null;
	    %>
		<script>
	...
	if(upid!=null&&upaddress!=null&&upid!=""&&upaddress!=""){
		GuAr guAr6 = new GuArDB().updateaddressA(upid,upaddress);
	    upaddress=null;
	    %>
		<script>
	...
	if(upid!=null&&upphone!=null&&upid!=""&&upphone!=""){
		GuAr guAr7 = new GuArDB().updatephoneA(upid,upphone);
	    upphone=null;
	    %>
		<script>
...
//Method and database statement for displaying information in database
		...
		String sql = "select * from shop_user order by id desc";
		...
		out.println("<h2><font color=blue>Admin Manage</font></h2>");
...
<!--Control to delete information in the database  -->
...
<!--Control to modify information in the database  -->
...
<input type="submit" value="Back to human resources"  style="width:300px;height:30%;font-size:16px"/>
</form>
<br/>
