<!-- Administrator information self-modification interface -->
...
List<GuAr> guArList = guArDB.searchmy(upusername,"shop_user");
...
//Determine if the database has the same user name
	if(username!=null&&password!=null&&names!=null&&sex!=null&&address!=null&&phone!=null&&username!=""&&password!=""&&names!=""&&sex!=""&&address!=""&&phone!=""){
		...
		out.println("<h2><font color=blue>Admin Imformation Manage</font></h2>");
